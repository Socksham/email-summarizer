      ...
      <div className="border flex flex-row h-full w-full">
        <div className="h-full bg-black w-full flex items-center justify-center">
          <div className="flex flex-col space-y-4 w-4/5 px-48">
            ...
            <button onClick={loginUser} className="px-4 py-2 text-xl bg-green-400 rounded-md text-white">Login</button>
            <GoogleSignInButton />
            <div className="flex justify-end cursor-pointer" onClick={goToSignup}>
                <p className="text-white underline">Create an account</p>
            </div>
          </div>
        </div>
